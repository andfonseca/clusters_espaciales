# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/00_clusters_espaciales.ipynb.

# %% auto 0
__all__ = ['data_points', 'Clusters']

# %% ../nbs/00_clusters_espaciales.ipynb 3
...
# %% ../nbs/00_clusters_espaciales.ipynb 4
class data_points:
...
# %% ../nbs/00_clusters_espaciales.ipynb 13
class Clusters:
